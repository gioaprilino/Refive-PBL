            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="{{ route('admin.principles.update', $principle) }} " enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="subtitle" id="subtitle" cols="30" value="{{ $principle->subtitle }}" rows="5" class="border border-slate-300 rounded-xl w-full">{{$principle->subtitle}}</textarea>
